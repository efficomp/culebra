...
"""Usage example of an homogeneous sequential island-based wrapper."""
...
# Wrapper
class Wrapper(SequentialDistributedTrainer, IslandsTrainer):
...
params = {
    ...
    "representatives_selection_func": partial(selTournament, tournsize=2),
    "topology_func": partial(ring_destinations, offset=1)
}

# Create the wrapper
subtrainers = tuple(
    NSGA(**subtrainer_params) for _ in range(num_subtrainers)
)
