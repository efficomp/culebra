...
# Wrapper
class Wrapper(SequentialDistributedTrainer, CooperativeTrainer):
...
best_cooperators = wrapper.best_cooperators()
...
wrapper.test(
    ...
    fitness_func=test_fitness_func,
    cooperators=best_cooperators
)
