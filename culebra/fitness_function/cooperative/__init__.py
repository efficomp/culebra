...
This module provides the following classes:
  ...
  * :py:class:`~fitness_function.cooperative.KappaNumFeatsC`:
    Tri-objective fitness class for feature selection. Maximizes the Kohen's
    Kappa index and minimizes the number of features that an individual has
    selected and also de C regularazation hyperparameter of the SVM-based
    classifier used within the wrapper.
"""
