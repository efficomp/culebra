...
* The :mod:`~culebra.fitness_function.tsp.abc` sub-module,
...
* Some scoring fitness functions:
  ...
  * :class:`~culebra.fitness_function.tsp.MultiObjectivePathLength`:
    Multi-objective fitness function for TSP problems.
  * :class:`~culebra.fitness_function.tsp.PathLength`: Single objective
