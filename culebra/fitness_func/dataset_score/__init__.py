...
* The :mod:`~culebra.fitness_func.dataset_score.abc` sub-module,
...
* Some popular scoring fitness functions:
  ...
  * :class:`~culebra.fitness_func.dataset_score.Accuracy`:
    Single-objective function that maximizes the Accuracy.
  * :class:`~culebra.fitness_func.dataset_score.KappaIndex`:
