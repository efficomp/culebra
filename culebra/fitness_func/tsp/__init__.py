...
* The :mod:`~culebra.fitness_func.tsp.abc` sub-module,
...
* Some scoring fitness functions:
  ...
  * :class:`~culebra.fitness_func.tsp.MultiObjectivePathLength`:
    Multi-objective fitness function for TSP problems.
  * :class:`~culebra.fitness_func.tsp.PathLength`: Single objective
