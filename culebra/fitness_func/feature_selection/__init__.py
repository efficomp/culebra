...
* The :mod:`~culebra.fitness_func.feature_selection.abc` sub-module,
...
* Some single-objective scoring fitness functions:
  ...
  * :class:`~culebra.fitness_func.feature_selection.Accuracy`:
    Single-objective function that maximizes the Accuracy for classification
    problems.
  * :class:`~culebra.fitness_func.feature_selection.FeatsProportion`:
    ...
    :class:`~culebra.fitness_func.feature_selection.NumFeats` is just that
    :class:`~culebra.fitness_func.feature_selection.FeatsProportion`
    returns a normalized number in [0, 1].
  * :class:`~culebra.fitness_func.feature_selection.KappaIndex`:
    Single-objective function that maximizes the Kohen's Kappa index for
    classification problems.
  * :class:`~culebra.fitness_func.feature_selection.NumFeats`: Dummy
