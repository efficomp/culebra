...
"""Topologies for distributed evolutionary wrappers."""
...
def ring_destinations(
    ...
    :param origin: The index of the origin subpopulation wrapper
    ...
    :param offset: Offset applied to *origin*, defaults to
        :py:attr:`DEFAULT_RING_OFFSET`
    :type offset: :py:class:`int`, optional
    :return: The direct destinations from *origin*
    :rtype: :py:class:`list` of subpopulation wrapper indexes
    """
