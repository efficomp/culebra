...
"""Test for :py:class:`wrapper.multi_pop.HeterogeneousParallelIslands`."""
...
from culebra.wrapper.multi_pop import (
    HeterogeneousParallelIslands as Wrapper,
...
class WrapperTester(unittest.TestCase):
    """Test :py:class:`wrapper.multi_pop.HeterogeneousParallelIslands`."""
    ...
    def test_init(self):
        ...
        self.assertEqual(wrapper.num_subpops, cpu_count())
        self.assertEqual(
