...
"""Unit test for :py:mod:`wrapper.multi_pop.topology`."""

import unittest
from culebra.wrapper.multi_pop.topology import (
    ring_destinations,
...
class TopologyTester(unittest.TestCase):
    """Test the :py:mod:`wrapper.multi_pop.topology` module."""

    def test_ring_destinations(self):
        """Test :py:func:`~wrapper.multi_pop.topology.ring_destinations`."""
