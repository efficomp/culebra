...
"""Unit test for :class:`culebra.trainer.aco.abc.ACO`."""
...
class TrainerTester(unittest.TestCase):
    """Test :class:`culebra.trainer.aco.abc.ACO`."""
    ...
    def test_init(self):
        ...
        self.assertEqual(
            single_obj_trainer.fitness_func, tsp_fitness_func_single
        )
        self.assertEqual(
            multi_obj_trainer.fitness_func, tsp_fitness_func_multi
        )
        ...
        self.assertEqual(
            ...
            (valid_initial_pheromone,) * tsp_fitness_func_multi.num_obj
        )
        ...
        self.assertEqual(
            ...
            tsp_fitness_func_multi.num_obj
        )
        ...
        self.assertEqual(
            single_obj_trainer.max_num_iters, DEFAULT_MAX_NUM_ITERS
        )
    ...
    def test_initial_pheromone_multi(self):
        ...
        self.assertEqual(
            ...
            (initial_pheromone,) * trainer.fitness_func.num_obj
        )
    ...
    def test_pheromone_influence_multi(self):
        ...
        for pheromone_influence in valid_pheromone_influence:
            ...
            self.assertEqual(
                trainer.pheromone_influence,
                (pheromone_influence,) * trainer.fitness_func.num_obj
            )
    ...
    def test_heuristic_influence_multi(self):
        ...
        for heuristic_influence in valid_heuristic_influence:
            ...
            self.assertEqual(
                trainer.heuristic_influence,
                (heuristic_influence,) * trainer.fitness_func.num_obj
            )
    ...
    def test_next_choice(self):
        ...
        # Try to generate valid first nodes
            ...
            for _ in repeat(None, times):
                ...
                ant = Ant(
                    trainer.species,
                    trainer.fitness_func.fitness_cls
                )
    ...
    def test_integrate_representatives(self):
        ...
        # Init the training and the next iteration to make an empty colony
        trainer._init_training()
        trainer._start_iteration()
        ...
        self.assertEqual(len(trainer.col), num_representatives)
        for ind in representatives:
            self.assertTrue(ind in trainer.col)
    ...
    def test_select_representatives(self):
        ...
        # Init the training and the next iteration
        trainer._init_training()
        trainer._start_iteration()
        ...
        num_subtrainers = 3
        subtrainers = tuple(
            MySingleObjTrainer(**params) for _ in range(num_subtrainers)
        )
    ...
    def _check_deepcopy(self, trainer1, trainer2):
        ...
        :type trainer1: ~culebra.trainer.aco.abc.ACO
        :param trainer2: The second trainer
        :type trainer2: ~culebra.trainer.aco.abc.ACO
        """
