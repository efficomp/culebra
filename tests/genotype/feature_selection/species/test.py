...
from culebra.genotype.feature_selection import Species, MAX_PROP


class SpeciesTester(unittest.TestCase):
    """Test :py:class:`feature_selector.Species`."""

    def test_init(self):
        """Test the :py:meth:`~feature_selector.Species.__init__` method."""
        # Default parameters
    ...
    def test_copy(self):
        """Test the :py:meth:`~feature_selector.Species.__copy__` method."""
        species1 = Species(15)
    ...
    def test_deepcopy(self):
        """Test :py:meth:`~feature_selector.Species.__deepcopy__`."""
        species1 = Species(18)
    ...
    def _check_deepcopy(self, species1, species2):
        ...
        :type species1: :py:class:`~feature_selector.Species`
        :param species2: The second species
        :type species2: :py:class:`~feature_selector.Species`
        """
