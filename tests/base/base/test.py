...
"""Unit test for :py:class:`base.Base`."""
...
class BaseTester(unittest.TestCase):
    """Test the :py:class:`~base.Base` class."""

    def test_copy(self):
        """Test the :py:meth:`~base.Base.__copy__` method."""
    ...
    def test_repr(self):
        """Test the: py: meth: `~base.Base.__repr__` method."""
        lists = [[], the_list]

        for value in lists:
            base = BaseSubclass(my_list=value)
            self.assertEqual(base.__repr__(),
